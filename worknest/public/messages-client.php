...
<body>
  <aside class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="messages-client.php" class="active"><i class="fas fa-comments"></i> Messages</a></li>
  ...
  <script>
    ...
    function renderConversations(conversations) {
      ...
      list.innerHTML = conversations.map(conv => `
        <a href="messages-client.php?user=${conv.other_user_id}" 
    ...
    function startConversation(userId) {
      ...
      window.location.href = `messages-client.php?user=${userId}`;
    }
